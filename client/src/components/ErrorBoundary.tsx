      ...
      return (
        <main className="grid min-h-screen place-items-center bg-[#F5F7FB] p-6 text-[#14213D]">
          <section className="w-full max-w-xl rounded-[1.75rem] border border-[#E4EAF4] bg-white p-8 text-center shadow-[0_20px_60px_rgba(24,54,108,0.10)] sm:p-10">
            <span className="mx-auto grid h-14 w-14 place-items-center rounded-2xl bg-[#FFF0F2] text-[#C63550]">
              <AlertTriangle className="h-7 w-7" />
            </span>
            <p className="mt-6 text-xs font-bold tracking-[0.16em] text-[#195FE6]">
              ELEGEX RECOVERY
            </p>
            ...
            <p className="mt-3 text-sm leading-6 text-[#667085]">
              Your data has not been changed. Retry the view first; if the issue
              persists, reload the application and quote the recovery identifier
              to the workspace administrator.
            </p>
            <p className="mt-4 font-mono text-xs font-semibold text-[#50617F]">
              {this.state.errorId || "ELX-RECOVERING"}
            </p>
            <div className="mt-7 flex flex-col justify-center gap-3 sm:flex-row">
              <button
                onClick={this.reset}
                className="inline-flex items-center justify-center gap-2 rounded-xl border border-[#D6E2F6] bg-white px-4 py-2.5 text-sm font-semibold text-[#195FE6] transition hover:bg-[#F5F8FF]"
              >
            ...
            <button
              ...
              className="mt-5 text-sm font-semibold text-[#667085] underline-offset-4 hover:text-[#195FE6] hover:underline"
            >
              Reload application
            </button>
          </section>
