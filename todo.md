...
- [ ] WP2: restore per-organization South African locale, ZAR currency, Africa/Johannesburg display timezone, trade vocabulary, and temporal call-out taxonomy. Schema is applied and dashboard query is repaired; visible USD formatting, UI/settings, seed, application, and verification remain pending.
