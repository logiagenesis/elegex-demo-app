...
export const contacts = mysqlTable(
  "contacts",
  {
    ...
    status: mysqlEnum("status", ["lead", "active", "inactive"])
      .default("lead")
      .notNull(),
    notes: text("notes"),
...
export const clients = mysqlTable(
  ...
  table => [
    ...
    foreignKey({
      columns: [table.billingEntityId],
      foreignColumns: [table.id],
      name: "clients_billing_entity_fk",
    }),
  ]
);
...
export const sites = mysqlTable(
  ...
  table => [
    ...
    foreignKey({
      ...
      name: "sites_client_fk",
    }),
    foreignKey({
      columns: [table.contactId],
      foreignColumns: [contacts.id],
      name: "sites_contact_fk",
    }),
  ]
);
...
export const projects = mysqlTable(
  ...
  table => [
    ...
    uniqueIndex("project_organization_code_unique").on(
      table.organizationId,
      table.code
    ),
  ]
...
export const cases = mysqlTable(
  ...
  table => [
    ...
    uniqueIndex("case_organization_reference_unique").on(
      table.organizationId,
      table.reference
    ),
  ]
...
export const tasks = mysqlTable(
  "tasks",
  {
    ...
    title: varchar("title", { length: 180 }).notNull(),
    description: text("description"),
    status: mysqlEnum("status", ["todo", "in_progress", "blocked", "complete"])
      .default("todo")
      .notNull(),
    priority: mysqlEnum("priority", ["low", "medium", "high", "urgent"])
      .default("medium")
...
export const documents = mysqlTable(
  "documents",
  {
    ...
    classificationLevel: mysqlEnum("classificationLevel", [
      "public",
      "internal",
      "confidential",
      "restricted",
  ...
  table => [
    ...
    index("document_type_retention_idx").on(
      table.organizationId,
      table.documentType,
      table.classificationLevel
    ),
    uniqueIndex("document_organization_storage_key_unique").on(
      table.organizationId,
      table.storageKey
    ),
  ]
...
export const activityLogs = mysqlTable(
  ...
  table => [
    index("activity_organization_idx").on(
      table.organizationId,
      table.createdAt
    ),
  ]
...
export const savedViews = mysqlTable(
  ...
  table => [
    index("saved_view_organization_idx").on(
      table.organizationId,
      table.resource
    ),
  ]
...
export const appSettings = mysqlTable("appSettings", {
  ...
  defaultProjectStatus: varchar("defaultProjectStatus", { length: 32 })
    .default("planning")
    .notNull(),
...
export const callOutTypes = mysqlTable(
  "callOutTypes",
  {
    id: int("id").autoincrement().primaryKey(),
    organizationId: int("organizationId").notNull(),
  ...
  table => [
    index("call_out_type_organization_idx").on(
      table.organizationId,
      table.activeFrom
    ),
    foreignKey({
      columns: [table.organizationId],
      foreignColumns: [organizations.id],
      name: "call_out_types_organization_fk",
    }),
  ]
);
...
export const integrationConnections = mysqlTable(
  "integrationConnections",
  {
    ...
    name: varchar("name", { length: 120 }).notNull(),
    status: mysqlEnum("status", ["active", "paused", "degraded", "disabled"])
      .default("active")
      .notNull(),
  ...
  table => [
    index("integration_connection_organization_idx").on(
      table.organizationId,
      table.status
    ),
    uniqueIndex("integration_connection_unique").on(
      table.organizationId,
      table.provider,
      table.name
    ),
...
export const integrationEvents = mysqlTable(
  ...
  table => [
    index("integration_event_dispatch_idx").on(
      table.connectionId,
      table.status,
      table.availableAt
    ),
    uniqueIndex("integration_event_idempotency_unique").on(
      table.connectionId,
...
export const jobs = mysqlTable(
  ...
  table => [
    uniqueIndex("job_organization_number_unique").on(
      table.organizationId,
      table.jobNumber
    ),
    index("job_organization_stage_idx").on(
      table.organizationId,
      table.stage,
      table.scheduledStart
    ),
    index("job_foreman_schedule_idx").on(
      table.organizationId,
      table.foremanId,
      table.scheduledStart
    ),
    index("job_client_site_idx").on(
      table.organizationId,
      table.clientId,
      table.siteId
    ),
    ...
    foreignKey({
      columns: [table.callOutTypeId],
      foreignColumns: [callOutTypes.id],
      name: "jobs_call_out_type_fk",
    }),
  ]
);

export const jobVisits = mysqlTable(
  "jobVisits",
  {
    id: int("id").autoincrement().primaryKey(),
    organizationId: int("organizationId").notNull(),
  ...
  table => [
    index("job_visit_dispatch_idx").on(
      table.organizationId,
      table.foremanId,
      table.scheduledStart
    ),
...
export const syncLogs = mysqlTable(
  ...
  table => [
    uniqueIndex("sync_log_idempotency_unique").on(
      table.organizationId,
      table.idempotencyKey
    ),
  ]
...
export const jobMaterials = mysqlTable(
  "jobMaterials",
  {
    id: int("id").autoincrement().primaryKey(),
    organizationId: int("organizationId").notNull(),
    ...
    source: mysqlEnum("source", ["catalog", "free_text", "client_supplied"])
      .default("catalog")
      .notNull(),
...
export const jobEvidence = mysqlTable(
  "jobEvidence",
  {
    id: int("id").autoincrement().primaryKey(),
    organizationId: int("organizationId").notNull(),
...
export const quotes = mysqlTable(
  ...
  table => [
    uniqueIndex("quote_organization_number_unique").on(
      table.organizationId,
      table.quoteNumber
    ),
    index("quote_organization_status_idx").on(
      table.organizationId,
      table.status,
      table.updatedAt
    ),
...
export const invoiceLinks = mysqlTable(
  "invoiceLinks",
  {
    id: int("id").autoincrement().primaryKey(),
    organizationId: int("organizationId").notNull(),
    jobId: int("jobId").notNull(),
    externalSystem: varchar("externalSystem", { length: 80 })
      .default("QuickBooks Online")
      .notNull(),
    externalInvoiceNumber: varchar("externalInvoiceNumber", {
      length: 80,
    }).notNull(),
    status: mysqlEnum("status", ["linked", "credited", "superseded"])
      .default("linked")
      .notNull(),
  ...
  table => [
    index("invoice_link_job_idx").on(
      table.organizationId,
      table.jobId,
      table.status
    ),
    uniqueIndex("invoice_link_external_reference_unique").on(
      table.organizationId,
      table.externalSystem,
      table.externalInvoiceNumber
    ),
  ]
);

export const monthlyOperationalSnapshots = mysqlTable(
  "monthlyOperationalSnapshots",
  {
    ...
    firstVisitResolutionRate: int("firstVisitResolutionRate")
      .default(0)
      .notNull(),
    customerSatisfactionIndex: int("customerSatisfactionIndex")
      .default(0)
      .notNull(),
    createdAt: timestamp("createdAt").defaultNow().notNull(),
  },
  table => [
    uniqueIndex("monthly_snapshot_organization_period_unique").on(
      table.organizationId,
      table.periodStart
    ),
  ]
...
export const environmentReleases = mysqlTable(
  "environmentReleases",
  {
    id: int("id").autoincrement().primaryKey(),
    organizationId: int("organizationId").notNull(),
  ...
  table => [
    index("environment_release_organization_idx").on(
      table.organizationId,
      table.environment,
      table.deployedAt
    ),
...
export const releaseChecks = mysqlTable(
  "releaseChecks",
  {
    id: int("id").autoincrement().primaryKey(),
  ...
  table => [
    index("release_check_release_idx").on(
      table.releaseId,
      table.category,
      table.status
    ),
